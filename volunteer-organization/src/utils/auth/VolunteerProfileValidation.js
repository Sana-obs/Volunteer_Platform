...
export const profileSchema = z.object({
  ...
  // interests صار محسوبًا تلقائيًا بالباك اند من فئات مهارات المتطوع —
  // لم يعد حقل فورم يُدخله المستخدم، فلا داعي لوجوده بـ schema التحقق
  // (راجع ProfileForm.jsx وProfilePreview.jsx لعرضه read-only فقط)
