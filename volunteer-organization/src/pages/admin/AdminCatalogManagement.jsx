...
import { Search, FolderOpen, Tags } from 'lucide-react'
...
export default function AdminCatalogManagement() {
  ...
  // `data ?? []` بترجع مرجعًا جديدًا كل render طالما data لسا undefined —
  // بتكسر useMemo(filteredCategories/filteredSkills) تحتها (نفس تحفّظ
  // AdminOrganizationsReview.jsx)
