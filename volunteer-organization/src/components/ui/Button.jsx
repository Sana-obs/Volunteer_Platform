...
export default function Button({
  ...
  const variantStyles = {
    ...
    // ghost variant for dark backgrounds (hero, black sections)
  ...
  // non-<button> elements (e.g. Link) have no real disabled — emulate it
  const isNativeButton = Component === "button";

  // Ripple: expands from the click point, then fades. Dark on ghost, light elsewhere.
  ...
  const classes = [
    ...
    // <a> is display:inline — won't honor fullWidth or center content like <button>
