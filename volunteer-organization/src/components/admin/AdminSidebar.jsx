    ...
    <NavLink
      ...
      className={({ isActive }) =>
        [
          ...
          'focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40',
          isActive
...
// Shared markup for both the fixed desktop rail and the mobile drawer.
  ...
  return (
    <div className="flex h-full flex-col bg-adminBg1 text-adminTextLo">
      <div className="flex items-center gap-3 border-b border-adminBorder px-5 py-5">
        {/* Stays primary — deliberate brand tie-in on the dark admin surface */}
      ...
      <div className="px-4 pt-4">
        <div className="rounded-2xl bg-adminBg2 border border-adminBorder p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {/* tone="secondary" + dark resolves to the adminAccent colors (see TONE_CLASSES_DARK) */}
      ...
      <div className="space-y-1 border-t border-adminBorder px-4 py-4">
        <NavLink
          to={ROUTES.HOME}
          onClick={onNavigate}
          className="flex items-center gap-3 rounded-2xl px-4 py-2.5 text-sm font-medium text-adminTextLo transition hover:bg-white/6 hover:text-adminTextHi focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40"
        >
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-2xl px-4 py-2.5 text-sm font-medium text-danger transition hover:bg-danger/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40"
        >
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="animate-shell-in relative flex h-full w-72 max-w-[85vw] flex-col border-r border-adminBorder bg-adminBg1 shadow-2xl">
            <button
              ...
              className="absolute right-3 top-4 flex h-9 w-9 items-center justify-center rounded-xl text-adminTextLo transition hover:bg-white/6 hover:text-adminTextHi focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40"
            >
