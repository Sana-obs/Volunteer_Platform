...
// Lightweight admin-area top bar; replaces the shared Navbar (hidden on /admin routes).
  ...
  return (
    ...
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-adminBorder bg-adminBg1 px-4 py-3 backdrop-blur sm:px-6 lg:px-8">
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-xl border border-adminBorder bg-adminBg2 text-adminTextHi transition hover:bg-white/6 focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40 lg:hidden"
      >
      ...
      <div className="flex flex-1 items-center justify-end gap-2">
        <NotificationBell
          ...
          triggerClassName="relative flex h-10 w-10 items-center justify-center rounded-xl border border-adminBorder bg-adminBg2 text-adminTextHi transition hover:bg-white/6 focus:outline-none focus-visible:ring-2 focus-visible:ring-adminAccent/40"
        />
